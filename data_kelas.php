                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Mengelolah Data Kelas</li>
                        </ol> <hr>
<!-- 	                        <div class="container"> -->
		                        <div class="card mb-4">
		                            <div class="card-header">
                                        <div class="d-flex align-items-center justify-content-between mb-0">
                                         <div class=" panel-title"><i class="fas fa-table me-1"></i>Tabel Kelas</div>
		                                ...
		                                <table id="datatablesSimple">
		                                    ...
		                                    <tbody>
		                                    	...
		                                    	<tr>
                                                    ...
                                                    <td>
                                                        <a href="tambah_kelas.php?ubah=<?php echo $result['id']; ?>" type="button" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit"><i class=" fa fa-solid fa-pencil" ></i></a>
                                                        <a href="proses_kelas.php?hapus=<?php echo $result['id']; ?>" type="button" class="btn btn-danger btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Hapus"><i class="fa fa-solid fa-trash"></i></a>
                                                    </td>
                                                </tr>
