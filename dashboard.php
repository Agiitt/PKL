                    ...
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <?php  
                                $q      = $conn->query("SELECT count(*) AS id FROM tbl_barang");
                                $barang = $q->fetch_array();
                                ?>
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Barang yang tersedia
                                        <div class="display-4"><?= $barang['id'] ?></div>
                                    </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="kelola_barang.php">View Details</a>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <?php  
                                $q      = $conn->query("SELECT count(*) AS id FROM tbl_pinjam");
                                $pinjam = $q->fetch_array();
                                ?>
                                <div class="card bg-info text-white mb-4">
                                    <div class="card-body">Siswa yang meminjam
                                        <div class="display-4"><?= $pinjam['id'] ?></div>
                                    </div>
