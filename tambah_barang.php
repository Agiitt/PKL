...
<!-- 	                        <div class="container"> -->
		                        <form method="POST" action="proses.php" enctype="multipart/form-data"> <br>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input required name="nama" type="name" class="form-control" id="nama_barang" value="<?php echo $nama; ?>" placeholder="Nama Barang" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="number" name="jumlah" required class="form-control" id="jumlah" value="<?php echo $jumlah; ?>" placeholder="Jumlah" min="1" max="100">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-sm-10">
                                            <input name="foto" type="file" class="form-control" id="foto" value="<?php echo $nama; ?>" <?php if(!isset($_GET['ubah'])) { echo "required"; }?> accept="img/*">
                                        </div>
                                    </div>
                                    ...
                                    <div align="mb-3 row mt-4">
                                        <div class="col" align="right">
                                            ...
                                            <a href="kelola_barang.php" class="btn btn-danger" type="button">
